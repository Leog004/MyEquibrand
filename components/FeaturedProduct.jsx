...
export default function FeaturedProduct() {
  ...
  <div className="hidden sm:flex flex-col items-center justify-center absolute sm:bottom-0 sm:right-0 md:bottom-32 md:right-48 h-sm w-50 mx-auto shadow-xl cursor-pointer animate-bounce-slow z-10">
