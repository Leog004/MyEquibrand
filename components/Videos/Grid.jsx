...
export default function Grid({data}) {
    ...
    return (
        <div class="px-12 py-8 transition-colors duration-200 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-gray-700 dark:border-gray-700 dark:hover:border-transparent">
        {
            !showVideo ? (
                <>
                <div class="flex flex-col sm:-mx-4 sm:flex-row">
                    ...
                    <div class="mt-4 sm:mx-4 sm:mt-0">
                        ...
                        <p class="mt-2 text-gray-500 capitalize dark:text-gray-300 group-hover:text-gray-300">{data.brand.title}</p>
                    </div>
                </div>

                <p class="mt-4 text-gray-500 capitalize dark:text-gray-300 group-hover:text-gray-300">{data.description}</p>
            </>
            )
            : <div class="flex flex-col sm:flex-row h-64 drop-shadow-2xl">
            ...
            <div class="flex mt-4 -mx-2">
                <a onClick={() => { handleOnClickCopy(data.youtubeVideoUrl);}} href="#!" class="flex mx-2 text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 group-hover:text-white" aria-label="facebook">
                ...
                >
                <svg class="w-6 h-6 fill-current mx-2 text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 group-hover:text-white" viewBox="0 0 24 24" fill="none"
