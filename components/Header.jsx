...
export default function Header() {
    ...
    return (
        ...
        <div className='flex items-center border-gray-800 px-4 py-2 border-l border-r m-0'>
            <Link href='#'><a className='cursor-pointer uppercase font-semibold text-xs'> <FontAwesomeIcon className='mr-2' icon={faUser}/> Sign In</a></Link>
        </div>
        ...
        <div className="container mx-auto flex flex-wrap px-20 py-5 flex-col md:flex-row items-center">
            <nav className="flex mx-auto flex-wrap items-center text-sm md:ml-auto relative">
                <Link href='#'><a className="mr-5 hover:text-gray-200 cursor-pointer border-b border-transparent hover:border-indigo-200"><span className='bg-red-500 absolute -top-5 -left-3 px-2 rounded-lg' style={{fontSize: '.5rem'}}>New</span>Products</a></Link>
                
                <Link href='#'><a className="mr-5 hover:text-gray-200 cursor-pointer border-b border-transparent hover:border-indigo-200">Advertising</a></Link>
                <Link href='#'><a className="mr-5 hover:text-gray-200 cursor-pointer border-b border-transparent hover:border-indigo-200">Saddles</a></Link>
                <Link href='#'><a className="mr-5 hover:text-gray-200 cursor-pointer border-b border-transparent hover:border-indigo-200">Ishare</a></Link>
                ...
                <Link href='#'><a className="mr-5 hover:text-gray-200 cursor-pointer border-b border-transparent hover:border-indigo-200">Catelogs</a></Link>
